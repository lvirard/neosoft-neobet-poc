...
describe("collaboratorsListStore", () => {
  ...
  it("filtre par nom", () => {
    ...
    expect(
      store.filteredCollaborators.every((c) =>
  ...
  it("retourne tous les profils si aucun filtre", () => {
    ...
    expect(store.filteredCollaborators.length).toBe(
      store.allCollaborators.length,
    );
  });
  ...
  it("filtre par agence", () => {
    ...
    expect(
      store.filteredCollaborators.every((c) => c.office.name === "Brest"),
    ).toBe(true);
  });
  ...
  it("filtre par titre", () => {
    ...
    expect(
      store.filteredCollaborators.every(
        (c) => c.title === "SOFTWARE_ENGINEERING",
      ),
    ).toBe(true);
  });
  ...
  it("filtre par séniorité", () => {
    ...
    expect(
      store.filteredCollaborators.every((c) => c.seniority === "Senior"),
    ).toBe(true);
  });
